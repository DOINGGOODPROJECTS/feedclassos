...
import { createPaymentIntent, getAllData, getChildById, getChildQr, getLedger, getSubscriptionPlans } from "@/lib/mockApi";
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        description={`Student ID: ${child.student_id} · QR, subscription, and ledger overview`}
